...
function RegisterPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-white px-4 dark:bg-neutral-950">
            ...
            <div className="flex flex-1 items-center justify-center">
                <form onSubmit={handleSubmit}
                    ...
                    <h1 className="text-xl font-semibold text-neutral-900 dark:text-neutral-50">Регистрация</h1>

                    <div className="space-y-1">
                        <label htmlFor="username" className="text-sm text-neutral-600 dark:text-neutral-400">Логин</label>
                        <input id="username"
                               name="username"
                               type="text"
                    ...
                    <div className="space-y-1">
                        <label htmlFor="password" className="text-sm text-neutral-600 dark:text-neutral-400">Пароль</label>
                        <input id="password"
                               name="password"
                               type="password"
